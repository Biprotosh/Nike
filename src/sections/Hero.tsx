    ...
    return (
        ...
        >
            <div className="flex flex-col relative items-start justify-center w-full max-xl:padding-x pt-28 xl:w-2/5">
                ...
                <h1 className="mt-10 font-palanquin font-semibold text-8xl max-sm:text-[72px]">
                ...
                <div className="w-full flex justify-start items-start mt-20 gap-10 sm:gap-16 flex-wrap">
            ...
            <div className="relative sm:flex flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center hidden">
                <img
                    src={bigShoeImg}
                    alt="Shoe collection"
                    width={610}
